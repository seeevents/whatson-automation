...
- IGNORE explicitement les "pseudo-evenements" recurrents generiques meme s'ils mentionnent un jour de la semaine ou une heure : Happy Hour, Ladies Night, promo boissons, brunch du dimanche recurrent sans line-up/artiste/theme specifique, et toute offre commerciale repetitive sans contenu evenementiel distinctif. Le simple fait d'avoir un jour identifiable (ex: "Happy Hour every Friday") ne suffit PAS a valider ces cas - ce sont des promotions permanentes du lieu, pas des evenements ponctuels a publier. Exception : si le Happy Hour/Ladies Night a un theme ou invite special ce jour-la (ex: "Ladies Night avec DJ Somebody ce vendredi"), traite-le comme un vrai evenement normalement.
